        ...
        <div>
                    ...
                    <div className="flex mt-16">
                        <div className="w-1/2 flex justify-end p">
                            <Image src={f1} alt="" height={100} width={400}/>
                        </div>
                            <div className="w-1/2 flex justify-start pl-4 mt-8">
                                <div className="text-2xl font-bold px-10">Brushed ruglan<br/>shirt<br/><br/>
                                    <Counter/><br/>$500<br/><br/><Link href={''}> <div className="bg-blue-200 p-4 border border-gray-500 text-center">ADD TO CART</div></Link>
                                </div>   
                            </div>
                    </div>
            <Support/>
